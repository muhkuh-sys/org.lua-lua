...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_windows_x86.tar.gz --gzip --directory /tmp/work/build/windows32/lua5.2/lua/install .'
...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_windows_x86_64.tar.gz --gzip --directory /tmp/work/build/windows64/lua5.2/lua/install .'
