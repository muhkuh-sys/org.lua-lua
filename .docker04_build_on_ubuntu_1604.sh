...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1604_x86.tar.gz --gzip --directory /tmp/work/build32/lua5.1/lua/install .'
...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1604_x86_64.tar.gz --gzip --directory /tmp/work/build64/lua5.1/lua/install .'
