...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1404_x86.tar.gz --gzip --directory /tmp/work/build_linux32/lua5.2/lua/install .'
...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1404_x86_64.tar.gz --gzip --directory /tmp/work/build_linux64/lua5.2/lua/install .'
