...
lxc init mbs-ubuntu-1610-x86 ${CONTAINER}
...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86.tar.gz --gzip --directory /tmp/work/build/linux/lua5.2/lua/install .'
lxc file pull ${CONTAINER}/tmp/work/build/build_ubuntu_1610_x86.tar.gz build/
