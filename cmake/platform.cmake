...
IF((NOT DEFINED JONCHKI_PLATFORM_DIST_ID) OR (NOT DEFINED JONCHKI_PLATFORM_DIST_VERSION) OR (NOT DEFINED JONCHKI_PLATFORM_CPU_ARCH))
	...
	ELSEIF(CMAKE_SYSTEM_NAME STREQUAL "Linux")
		...
		IF(GETCONF_RESULT EQUAL 0)
			IF(GETCONF_OUTPUT STREQUAL "32")
				SET(JONCHKI_PLATFORM_CPU_ARCH "x86")
			ELSEIF(GETCONF_OUTPUT STREQUAL "64")
				SET(JONCHKI_PLATFORM_CPU_ARCH "x64_86")
			ELSE(GETCONF_OUTPUT STREQUAL "32")
				MESSAGE(FATAL_ERROR "The getconf tool returned a strange number of bits: '${GETCONF_OUTPUT}'")
			ENDIF(GETCONF_OUTPUT STREQUAL "32")
