...
elseif strDistId=='ubuntu' then
  if strDistVersion=='12.04' then
    if strCpuArch=='x86' then
      t:install('ubuntu_1204_x86/lua5.2',         '${install_executables}/')
      t:install('ubuntu_1204_x86/wlua5.2',        '${install_executables}/')
      t:install('ubuntu_1204_x86/lua5.2.so',      '${install_shared_objects}/')
      t:install('ubuntu_1204_x86/dev/include',    '${install_dev_include}/')
      t:install('ubuntu_1204_x86/dev/cmake',      '${install_dev_cmake}/')
    elseif strCpuArch=='x86_64' then
      t:install('ubuntu_1204_x86_64/lua5.2',      '${install_executables}/')
      t:install('ubuntu_1204_x86_64/wlua5.2',     '${install_executables}/')
      t:install('ubuntu_1204_x86_64/lua5.2.so',   '${install_shared_objects}/')
