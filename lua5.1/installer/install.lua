...
elseif strDistId=='ubuntu' then
  ...
  elseif strDistVersion=='17.04' then
    if strCpuArch=='x86' then
      t:install(    'ubuntu_1704_x86/lua5.1',         '${install_executables}/')
      t:install(    'ubuntu_1704_x86/wlua5.1',        '${install_executables}/')
      t:install(    'ubuntu_1704_x86/lua5.1.so',      '${install_shared_objects}/')
      t:install_dev('ubuntu_1704_x86/dev/include',    '${install_dev_include}/')
      t:install_dev('ubuntu_1704_x86/dev/cmake',      '${install_dev_cmake}/')
      tResult = true
    elseif strCpuArch=='x86_64' then
      t:install(    'ubuntu_1704_x86_64/lua5.1',      '${install_executables}/')
      t:install(    'ubuntu_1704_x86_64/wlua5.1',     '${install_executables}/')
      t:install(    'ubuntu_1704_x86_64/lua5.1.so',   '${install_shared_objects}/')
  ...
  elseif strDistVersion=='17.10' then
    if strCpuArch=='x86' then
      t:install(    'ubuntu_1710_x86/lua5.1',         '${install_executables}/')
      t:install(    'ubuntu_1710_x86/wlua5.1',        '${install_executables}/')
      t:install(    'ubuntu_1710_x86/lua5.1.so',      '${install_shared_objects}/')
      t:install_dev('ubuntu_1710_x86/dev/include',    '${install_dev_include}/')
      t:install_dev('ubuntu_1710_x86/dev/cmake',      '${install_dev_cmake}/')
      tResult = true
    elseif strCpuArch=='x86_64' then
      t:install(    'ubuntu_1710_x86_64/lua5.1',      '${install_executables}/')
      t:install(    'ubuntu_1710_x86_64/wlua5.1',     '${install_executables}/')
      t:install(    'ubuntu_1710_x86_64/lua5.1.so',   '${install_shared_objects}/')
