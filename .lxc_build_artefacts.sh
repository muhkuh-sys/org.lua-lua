...
lxc file push build/build_ubuntu_1404_x86.tar.gz ${CONTAINER}/tmp/work/build/
...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/org.lua.lua-lua5.1/targets/jonchki/repository/org/lua/lua/*" -type f'`
echo ${FILELIST}
