...
docker exec ${ID} bash -c 'apt-get install --assume-yes imagemagick icoutils'
...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_windows_x86.tar.gz --gzip --directory /tmp/work/build_windows32/lua5.2/lua/install .'
...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_windows_x86_64.tar.gz --gzip --directory /tmp/work/build_windows64/lua5.2/lua/install .'
